// Объект с переводами
    const translations = {
      ru: {
        ...
        image_counter: "1/10",
        news1_p1: "Друзья, это свершилось! Демо-версия «Под покровом солнца» вышла в Steam! Ссылка для скачивания:",
        news_link_text: "Жми сюда",
        news2_p1: "Друзья, это свершилось! Демо-версия «Под покровом солнца» вышла в Steam! Ссылка для скачивания:",
        news2_link_text: "Жми сюда"
      },
      en: {
        ...
        image_counter: "1/10",
        news1_p1: "Friends, it happened! The demo version of 'Under the Cover of the Sun' is out on Steam! Download link:",
        news_link_text: "Click here",
        news2_link_text: "Click here",
        news1_p2: "Welcome to a cozy and picturesque village where time flows slowly and calmly, like a river that quietly flows through green fields and forests.",  
      }
    };
...
function changeLanguage(lang) {
  ...
  if (activeCharacter) {
    ...
    const characterName = translations[lang][`char${characterId}_name`];
    const characterDesc = translations[lang][`char${characterId}_desc`];
